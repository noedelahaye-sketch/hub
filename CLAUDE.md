...
- `duree` int (nullable) CHECK (5 à 1440) — **combien de temps la tâche prend, en minutes.** Elle se **tape à la main** (demande de Noé) ; les propositions ne sont qu'un raccourci.
  ...
  - **Après coup**, elle vaut sans heure : « ça m'a pris 45 minutes » est vrai d'une tâche qui n'occupait aucun créneau. C'est la question posée **au moment où on coche** — `demanderLaDuree` (js/gabarits.js), la seule source d'heures du hub.
...
- **Le hub ne demande qu'après.** La seule question qu'il pose de lui-même — « combien de temps ça a pris ? » — arrive une fois la chose faite, ne bloque rien, ne vole pas le focus, et s'en va toute seule au bout de dix secondes. Une question qui attend indéfiniment devient une corvée.
